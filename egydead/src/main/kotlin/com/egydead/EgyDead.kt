...
class EgyDead : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "$mainUrl/type/isekai/" to "Isekai | إيسيكاى",
        "$mainUrl/type/talk-shows/" to "Talk Shows | برامج حوارية",
        "$mainUrl/type/detective/" to "Detective | بوليسي",
        "$mainUrl/type/history/" to "History | تاريخي",
        "$mainUrl/type/reality-shows/" to "Reality Shows | تلفزيون الواقع",
        "$mainUrl/type/crime/" to "Crime | جريمة",
        "$mainUrl/type/josei/" to "Josei | جوسي",
        "$mainUrl/type/war/" to "War | حربي",
        "$mainUrl/type/harem/" to "Harem | حريم",
        "$mainUrl/type/supernatural/" to "Supernatural | خارق للطبيعة",
        "$mainUrl/type/sci-fi/" to "Sci-Fi | خيال علمي",
        "$mainUrl/type/drama/" to "Drama | دراما",
    "$mainUrl/type/horror/" to "Horror | رعب",
    "$mainUrl/type/romance/" to "Romance | رومانسي",
    "$mainUrl/type/sports/" to "Sports | رياضي",
    "$mainUrl/type/parody/" to "Parody | ساخر",
    "$mainUrl/type/samurai/" to "Samurai | ساموراي",
    "$mainUrl/type/seinen/" to "Seinen | سينن",
    "$mainUrl/type/biography/" to "Biography | سيرة ذاتية",
    "$mainUrl/type/slice-of-life/" to "Slice of Life | شريحة من الحياة",
    "$mainUrl/type/shoujo/" to "Shoujo | شوجو",
    "$mainUrl/type/shounen/" to "Shounen | شونين",
    "$mainUrl/type/cooking/" to "Cooking | طبخ",
    "$mainUrl/type/medical/" to "Medical | طبي",
    "$mainUrl/type/family/" to "Family | عائلي",
    "$mainUrl/type/military/" to "Military | عسكري",
    "$mainUrl/type/mystery/" to "Mystery | غموض",
    "$mainUrl/type/fantasy/" to "Fantasy | فانتازيا",
    "$mainUrl/type/space/" to "Space | فضاء",
    "$mainUrl/type/martial-arts/" to "Martial Arts | فنون قتالية",
    "$mainUrl/type/film-noir/" to "Film Noir | فيلم نوار",
    "$mainUrl/type/short/" to "Short | قصير",
    "$mainUrl/type/super-power/" to "Super Power | قوة خارقة",
    "$mainUrl/type/classic-movies/" to "Classic | كلاسيك",
    "$mainUrl/type/comedy/" to "Comedy | كوميديا",
    "$mainUrl/type/game/" to "Game | لعبة",
    "$mainUrl/type/school/" to "School | مدرسي",
    "$mainUrl/type/game-show/" to "Game Show | مسابقات",
    "$mainUrl/type/vampire/" to "Vampire | مصاصي دماء",
    "$mainUrl/type/adventure/" to "Adventure | مغامرة",
    "$mainUrl/type/music/" to "Music | موسيقي",
    "$mainUrl/type/mecha/" to "Mecha | ميكا",
    "$mainUrl/type/documentary/" to "Documentary | وثائقي",
    "$mainUrl/type/western/" to "Western | ويسترن",
